...
export default function DashboardLayout({ children }) {
  ...
  return (
    <SidebarProvider style={{ 
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4 transition-[width,height,padding] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 group-has-[[data-collapsible=icon]]/sidebar-wrapper:px-2">
